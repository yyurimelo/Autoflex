...
public class ProductionSuggestionPageResponse {
    private List<ProductionSuggestionResponse> content;
    ...
    public List<ProductionSuggestionResponse> getContent() {
        return content;
    }

    public void setContent(List<ProductionSuggestionResponse> content) {
        this.content = content;
    }

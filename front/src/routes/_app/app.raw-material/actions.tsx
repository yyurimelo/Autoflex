...
export function RawMaterialActions({ item }: Props) {
	const id = useId();
	...
	const { mutateAsync: removeRawMaterialFn } = useDeleteRawMaterialMutation(item.id)

	async function handleDelete() {
		await removeRawMaterialFn();
	...
	return (
		<>
			...
			<RawMaterialUpdate open={showEdit} setOpen={setShowEdit} item={item} />
